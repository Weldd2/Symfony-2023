...
class AuteurRepository extends ServiceEntityRepository
{
	...
	public function findAllWithLivresAndNationalites(): array
	{
		$queryBuilder = $this->createQueryBuilder('auteur')
			->select('auteur', 'livres', 'nationalite')
			->leftJoin('auteur.livres', 'livres')
			->leftJoin('auteur.nationalite', 'nationalite')
			->getQuery();
